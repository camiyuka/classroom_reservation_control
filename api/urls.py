...
from .views import ClassroomInsert, ClassroomView, ClassroomUpdate
...
urlpatterns = [
    ...
    path('classrooms/classroom/<str:document_id>/update/', ClassroomUpdate.as_view(), name='update_classroom'),
